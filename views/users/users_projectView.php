            ...
            <div class="cell-lg-8 cell-md-10">
              ...
              <div class="blog-item text-left">
                ...
                <div class="range range-10">
                  ...
                  <div class="unit__left"><a href=<?php echo "projectView?hid=$id"; ?>><div class="image-circles" style="background:url(<?php echo $image_1 ?>); height:80px; width: 80px; background-size: cover; background-position: center; background-repeat: no-repeat;" class=""> </div></a></div>
                  <div class="unit__body">
                        <time datetime="2018-03-31"><?php echo $date_created; ?></time>
                        <p><a class="text-bold" href="#"><?php echo $project_name; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <?php } ?>
