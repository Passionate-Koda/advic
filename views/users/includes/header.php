...
<!-- Mirrored from livedemo00.template-help.com/wt_prod-3849/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jul 2018 19:30:48 GMT -->
<head>
    <!-- Site Title-->
    <title> Advic Farms| <?php echo $page_title ?></title>
    <meta name="format-detection" content="telephone=no">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta charset="utf-8">
  <link rel="icon" href="images/ADVICICON.png"  type="image/png">
    <!-- Stylesheets-->
  ...
  <body>
    ...
    <div class="text-center text-sm-left page">
     ...
     <!--  <div class="preloader">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                   ...
                   <li><a href="project">Projects
                    ...
                    <li class=""><a href="contact">Contacts
                        <svg class="button-santos" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">
                          <rect class="shape" width="100%" height="100%" x="0" y="0"></rect>
                        </svg></a>
                    </li>
      ...
      <!-- Breadcrumbs-->
      <section class="breadcrumbs-custom text-left" style="background-image: url(images/breadcrumbs-about-1920x1000.jpg);">
        <div class="shell">
          <h2 class="breadcrumbs-custom__title"> <?php echo ucwords($page_title) ?></h2>
